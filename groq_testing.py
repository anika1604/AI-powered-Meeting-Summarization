...
filename_audio = os.path.dirname(__file__) + "/audio_samples/sample-0.mp3"
...
filename_transcript = os.path.dirname(__file__) + "/transcription/sample_transcript.txt"
...
with open(filename_transcript, "rb") as file:
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": f"generate a summary of the meeting:\n\n {contents}"
            }
        ],
        temperature=0.6,
